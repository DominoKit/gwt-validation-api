...
public interface ConstraintViolation<T> {
   ...
   *
   * <ul>
   *   <li>the {@code ConstraintViolation} is returned after calling {@link
   *       Validator#validateValue(Class, String, Object, Class[])}
   *   <li>the {@code ConstraintViolation} is returned after validating a constructor.
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>the bean instance the constraint is applied on if it is a bean constraint
   *   <li>the bean instance hosting the property the constraint is applied on if it is a property
   *       constraint or a container element constraint hosted on a property
   *   <li>{@code null} when the {@code ConstraintViolation} is returned after calling {@link
   *       Validator#validateValue(Class, String, Object, Class[])}
   *   <li>the object the method is executed on if it is a method parameter, cross-parameter or
   *       return value constraint or a container element constraint hosted on a method parameter or
   *       return value
   *   <li>{@code null} if it is a constructor parameter or cross-parameter constraint or a
   *       container element constraint hosted on a constructor parameter
   *   <li>the object the constructor has created if it is a constructor return value constraint
   * </ul>
   *
   ...
   *
   * <p>Returns {@code null} if the method has no return value. Returns {@code null} otherwise.
   *
