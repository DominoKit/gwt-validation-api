...
public interface ConstraintDescriptor<T extends Annotation> {
   ...
   * only the {@link Default} group is returned.
   *
  ...
  /**
   * The {@link ConstraintTarget} value of {@code validationAppliesTo} if the constraint hosts it or
   * {@code null} otherwise.
   *
   ...
   * values as value.
   *
   * <p>If this constraint is used as part of a composed constraint, attribute values are reflecting
   ...
   *
   * @return a set of {@code ConstraintDescriptor} objects or an empty set in case there are no
  ...
  /**
   * @return a {@link ValidateUnwrappedValue} describing the unwrapping behavior as given via the
   *     {@link Unwrapping} constraint payloads.
   * @since 2.0
   */
   ...
   *
   * <p>If the Jakarta Bean Validation provider implementation does not support the specified class,
