...
public interface Validator {
   ...
   *     {@code null}, empty or not a valid object property or if {@code null} is passed to the
   *     varargs groups
   * @throws ValidationException if a non recoverable error happens during the validation process
   */
   ...
   *
   * <p>{@link ConstraintViolation} objects return {@code null} for {@link
   ...
   *
   * <p>The returned object (and associated objects including {@link ConstraintDescriptor}s) are
   * immutable.
   *
