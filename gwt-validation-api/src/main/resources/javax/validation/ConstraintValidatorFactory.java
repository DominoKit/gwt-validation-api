...
/**
 * Instantiates a {@link ConstraintValidator} instance based off its class. The {@code
 * ConstraintValidatorFactory} is <b>not</b> responsible for calling {@link
...
public interface ConstraintValidatorFactory {
  ...
  /**
   * Signals {@code ConstraintValidatorFactory} that the instance is no longer being used by the
