 ...
 *
 * <p>Implementations must comply to the following restriction:
 *
 * <ul>
 *   <li>{@code T} must resolve to a non parameterized type
 *   <li>or generic parameters of {@code T} must be unbounded wildcard types
 * </ul>
 *
 * <p>The annotation {@link SupportedValidationTarget} can be put on a {@code ConstraintValidator}
 * implementation to mark it as supporting cross-parameter constraints. Check out {@link
 * SupportedValidationTarget} and {@link Constraint} for more information.
 *
