...
public interface BootstrapState {
  ...
  /**
   * User defined {@code ValidationProviderResolver} strategy instance or {@code null} if undefined.
   *
  ...
  /**
   * Specification default {@code ValidationProviderResolver} strategy instance.
   *
