...
/**
 * A group conversion rule to be applied during cascaded validation. Two group conversion
 * descriptors are considered equal if they have the same {@code from} and {@code to} group
 * respectively.
 *
