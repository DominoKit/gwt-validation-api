 ...
 * {@code Configuration} are merged and passed along via {@code ConfigurationState}.</p>
 *
...
public interface ConfigurationState {
   ...
   * <p>
   * In this case, the {@link ValidatorFactory} must ignore {@code META-INF/validation.xml}.</p>
   *
   ...
   * adhere to the mark/reset contract (see {@link InputStream#markSupported()} by the Jakarta Bean
   * Validation provider.
   * </p>
   *
   ...
   * <li>{@code META-INF/validation.xml} provided that {@code ignoreXmlConfiguration} is
   * {@code false}.</li>
   * </ul>
   * </p>
   * <p>
